        ...
        option = {
            ...
            tooltip:{//信息框
                ...
                formatter:function (params,ticket) {
                    var tpls = "<div class='acb'><h3 class='fl'>" + params.name + "</h3><div class='fr bigfont'>" + params.value[2] + "</div></div>" + "<div><p>等级：" + params.value[3] + "</p><p>AQI：" + params.value[4] + "</p><p>主要污染物：" + params.value[5] + "</p></div>";
                    return tpls;
                },
